...
copy %~dp0\README.md %~dp0\windows\README.mdrem build the program with release optimisation (remove -r for faster build, the bottleneck is always responses from api.scryfall anyway)
cargo build